      ...
      <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
        <div class="row justify-content-center mb-4">
          <div class="col-md-10 text-center">
            <h1>
              A Digital Marketing Agency Built on
              <span class="typed-words"></span>
            </h1>
            <div>
              <a href="<?php echo SITE_PATH ?>/contact" class="btn btn-primary btn-md">Get Free Consultation</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 mt-5">
      <div class="col-md-8 text-center">
        <h2 class="site-section-heading text-center">Our Clients</h2>
      </div>
    </div>
    ...
    <div class="row align-items-stretch">
      <div class="col-12 w-100 ft-feature-1-content">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <img src="images/why-chose-us.jpg" alt="Image" class="img-fluid mb-4 mb-lg-0" />
          </div>
          <div class="col-lg-7 ml-auto">
            <div class="row w-100">
              <div class="col-lg-6">
                <div>
                  <h3 class="d-flex align-items-center">
                    <span class="icon icon-beach_access mr-2"></span><span>Professionalism</span>
                  </h3>
                  <p>
              ...
              <div class="col-lg-6">
                <div>
                  <h3 class="d-flex align-items-center">
                    <span class="icon icon-build mr-2"></span><span>Experienced Minds</span>
                  </h3>
                  <p>
              ...
              <div class="col-lg-6">
                <div>
                  <h3 class="d-flex align-items-center">
                    <span class="icon icon-format_paint mr-2"></span><span>Hit Targets</span>
                  </h3>
                  <p>
              ...
              <div class="col-lg-6">
                <div>
                  <h3 class="d-flex align-items-center">
                    <span class="icon icon-question_answer mr-2"></span><span>Affordability</span>
                  </h3>
                  <p>
...
<section class="site-section testimonial-wrap">
  <div class="container mb-5">
    <div class="row justify-content-center">
      <div class="col-md-8 text-center">
        <h2 class="site-section-heading text-center">What Our Clients Says</h2>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="slide-one-item home-slider owl-carousel">
      <div>
        <div class="testimonial">
          <blockquote class="mb-5">
            <p>
              &ldquo;The social media marketing process of Web Marlins has boosted the online visibility of our brand. Our number of followers has increased, thanks to their interesting content and clever techniques, which have also led to fruitful exchanges. They have a true grasp of audience enchantment.&rdquo;
            </p>
          </blockquote>

          <figure class="mb-4 d-block align-items-center justify-content-center">
            <div>
              <img src="images/testimonials/1.webp" alt="Image" class="w-50 img-fluid mb-3" />
            </div>
            <p>Abhishek Tripathi</p>
          </figure>
        </div>
      </div>
      <div>
        <div class="testimonial">
          <blockquote class="mb-5">
            <p>
              &ldquo;For our company, the SEO know-how of Web Marlins has been a game-changer. Their rigorous optimization techniques assisted us in moving up the search engine results, greatly boosting organic traffic. We are overjoyed with the outcomes.&rdquo;
            </p>
          </blockquote>
          <figure class="mb-4 d-block align-items-center justify-content-center">
            <div>
              <img src="images/testimonials/2.webp" alt="Image" class="w-50 img-fluid mb-3" />
            </div>
            <p>Khwaja Azhar</p>
          </figure>
        </div>
      ...
      <div>
        <div class="testimonial">
          <blockquote class="mb-5">
            <p>
              &ldquo;Our internet advertising initiatives have excelled due to Web Marlins' clever PPC tactics. Our conversions have increased because of their targeted strategy and ongoing optimization, which has also helped us increase our ROI. highly advisable&rdquo;
            </p>
          </blockquote>
          <figure class="mb-4 d-block align-items-center justify-content-center">
            <div>
              <img src="images/testimonials/3.webp" alt="Image" class="w-50 img-fluid mb-3" />
            </div>
            <p>Joshua Olayemi</p>
          </figure>
        </div>
...
<section class="site-section border-bottom" id="services-section">
  <div class="container">
    ...
    <div class="row align-items-stretch">
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="300">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="400">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="500">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
      ...
      <div class="col-md-6 col-lg-4 card align-items-center justify-content-center" data-aos="fade-up" data-aos-delay="500">
        <div class="text-center card-cover">
          <div class="card-icon mr-4">
            <span class="text-primary icon-search2"></span>
          </div>
          <div>
...
<div class="site-section" id="about-section">
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-5 ml-auto mb-5 order-md-2">
        <img src="images/about-us.png" alt="Image" class="img-fluid rounded" />
      </div>
  ...
  <section class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 mb-5" data-aos="fade-in" data-aos-delay="0">
