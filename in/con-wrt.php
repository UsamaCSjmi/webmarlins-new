...
<?php include_once("assets/header.php")?>
      ...
      <section class="site-section">
        <div class="container">
          <form class="p-5 bg-white rounded" onsubmit="validateForm(this)">
            <h2 class="h4 mb-5 text-center">Let's Connect for a Free Custom Quote</h2>
      ...
      <section class="site-section">
        <div class="container">
          ...
          <h2 class="text-primary text-center mb-3">
            Our Comprehensive Content Writing Solutions
          </h2>
          <div class="row">
            <div class="col-md-6 col-lg-4 ">
              <div class="box-with-humber bg-white p-5 h-100">
