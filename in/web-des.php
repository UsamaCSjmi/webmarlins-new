            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              <div class="row justify-content-center mb-4">
                <div class="col-md-10 text-center">
                  ...
                  <p class="text-light">
                    Transform your online identity with Web Marlins' innovative web design solutions, crafting visually stunning and user-centric websites that leave a lasting impression.
                  </p>
                  <div>
                    <a
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-left my-auto">
              <h4 class="h4">Where Design Meets Digital Brilliance, Web Experiences that Leave an Indelible Impression</h4>
              <h2 class="h2">At Web Marlins, Design Meets Brilliance</h2>
            ...
            <div class="col-md-6">
              <form action="#" class="p-5 bg-white">
                <h2 class="h4 mb-5">Signup for a Free Consultation</h2>
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    ...
                    <textarea name="comments" id="comments" cols="30" rows="3" class="form-control" placeholder="Write your notes or questions here..."></textarea>
                  </div>
                </div>
      ...
      <section class="site-section">
        <div class="container">
          <h2 class="text-primary text-center mb-3">
            Web Design Service at Web Marlins
          </h2>
          <p class="text-primary text-center mt-3">
            Experience the pinnacle of web designing services in Delhi with Web Marlins, where every pixel is strategically crafted to create captivating digital experiences that captivate your audience and drive business success.
          </p>
          <div class="row">
        ...
        <div class="container">
          <div class="row justify-content-center mb-5">
            <div class="col-lg-12 text-center" data-aos="fade-up">
              <h3 class="text-primary">Leading Web Design Agency in Delhi</h3>
              <p class="text-primary">
                Experience the game-changing effects of our top website design agency in Delhi, where innovative design meets technical know-how to take your business to new heights online.
              </p>
            </div>
