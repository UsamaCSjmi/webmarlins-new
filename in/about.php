<?php include_once("assets/header.php")?>
  ...
  <section class="site-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          <h2 class="site-section-heading text-center">Web Marlin’s Excels In</h2>
          <p class="text-primary text-center">
            We are a strategic partner at Web Marlins committed to bringing your brand to new heights rather than just another digital marketing company in Delhi. Together, let's take this thrilling adventure and realize the full potential of your online presence.
          </p>
        </div>
      </div>
    </div>
